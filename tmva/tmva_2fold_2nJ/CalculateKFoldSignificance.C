...
void CalculateKFoldSignificance() {
    // ---------------------------------------------------------
    // 1. 初始化两个 TMVA Reader
    // ---------------------------------------------------------
    ...
    readerEven->BookMVA("BDT_Even", "/home/haoran/tmva/tmva_2fold_2nJ/dataset_Even/weights/TMVAClassification_Even_BDT_nJ2.weights.xml");
    readerOdd->BookMVA("BDT_Odd", "/home/haoran/tmva/tmva_2fold_2nJ/dataset_Odd/weights/TMVAClassification_Odd_BDT_nJ2.weights.xml");
    ...
    // 3. 绑定 Tree 变量 (注意类型匹配)
    // ---------------------------------------------------------
    float tree_mBB, tree_dRBB, tree_pTV;
    float eventWeight;
    int nJ;
